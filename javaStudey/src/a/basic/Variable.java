...
public class Variable {
	...
	public static void main(String[] args) {
		...
		/*
		 * 정수형 자료형 byte(1), short(2), int(4), long(8) 모두 정수를 저장하는 자료형, 각 자료형마다 표현할 수 있는
		 * 수의 변위가 다르다.
		 */
		 ...
		 * 문자열
		 * String(=============객체==============)
		 * 문자열 같은 경우 할당해야할 메모리크기가 너무 가변적으로 원시타입이 아닌 객체로 변수를 만들어준다.
		 */
		...
		final int MY_AGE;
		MY_AGE = 90;
//		MY_AGE = 111; 값을 초기화하면 더 이상 변경할 수 없다.
