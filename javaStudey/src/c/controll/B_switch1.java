...
public class B_switch1 {
	...
	*/
		...
		/*
		String fruit;
		System.out.println("구매하고자하는 과일(사과(2000), 바나나(3000), 딸기(5000)) 입력 :");
		fruit = sc.next();
		
		switch (fruit ) {
		case "사과":
			System.out.println(fruit+ "의 가격은 2000입니다.");
			break;
		case  "바나나":
			System.out.println(fruit + "의 가격은 3000입니다.");
			break;
		case "딸기":
			System.out.println(fruit + "의 가격은 5000입니다.");
			break;
		default:
			System.out.println("잘못입력하셨습니다.");
			}
