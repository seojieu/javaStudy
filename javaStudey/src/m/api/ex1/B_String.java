...
public class B_String {
	...
	public void method01() {
		...
		//String클래스에서 equalse메소드는 이미 오버라이딩 되어있음(주소값이 아닌 값비교)
		System.out.println(str1.equals(str2));
		
		//String클래스에서 hashCode메소드 이미 오버라이딩 되어있음(주소값이 아닌 문자열을 가지고 만들도록)
	...
	public void method02 () {
		...
		//   문자역에서 전달받은 index 위치에 문자만을 추출해서 리턴
		...
		//		문자열.toLowerCace() : String => 문자열을 전부 소문자로 변경해서 반환
	...
	public void method03() {
		...
		//				java.util.S	tringTokenizer클래스를 이용
		//				StringTkenizer stn = new StringTokenizer(배열, 구분자)
