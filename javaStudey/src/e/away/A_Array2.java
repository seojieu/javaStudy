...
public class A_Array2 {
	...
	public static void main(String[] args) {
			...
			*/
			...
			/*
			 * 실제 리터럴값을 곧바로 담을 수 있는 변수를 알변수아고 합읻.
			 * 주소값을 담고 있는 변수는 참조 변수 (세퍼런스 변수)라고 표현
			 * 
			 * 기본자료형(원시타입) : boolean, int, char, byte, long, double등등으로 선언된 변수
			 * => 실제 리터럴 값을 바로 담을 수 없다.
			 * 
			 * 그외 자료형(String, Scanner, int[], double[], char[])
			 */
			...
			arr = new int[5];
			/*
			 * ArrayIndexOutOfBoundsExveption
