...
/*
 	package
 	클래스간의 공간적 충돌이나 접근방법의 충돌을 막기위해 저장위치를 구분하여 명확하게 접근할 수 있도록 해주는 것
...
public class Run {
	...
	public static void main(String[] args) {
		/*
		 	...
		 	3. 객체지향 프로그래밍 : 현실세계의 객체들간의 상호작용 -> 프로그래밍을 통해서 기상세계롤 구현하는 가장 효과적인 방법
		 	...
		 	ex) 학생 관리 프로그램
		 	1) 학생관련 객체(푀경채훈련생,최용준훈련생, 안재휘훈련생 등등. . .)
		 	2) 공통적인 속성및 기능(이름, 나이, 주소, 전화번호, 키 , 몸무게 , 머리색, 달리기속도, 먹는다, 잔다, 화장실간다, 휴식한다)
		 	...
		 	4) 이름 : String name
		 		...
		 		6. 추상화한 객체를 프로그램에 적용시키기
		 			1. " 변수"만으로 프로그래밍을 한다.
		 				...
		 				안재휘라는 훈련생 객체 하나 만들기 -> String name1 = "안재휘"; int age = 20; double height = 185.0;
