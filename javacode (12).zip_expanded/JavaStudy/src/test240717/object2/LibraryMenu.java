...
public class LibraryMenu {
	...
	public LibraryMenu() {
		super();
		this.lc = new LibraryController();						//why?
		this.sc = new Scanner(System.in); 						//LibraryController lc = new LibraryController();
	...
	public void mainMenu() {
		...
		lc.insertMember(name,age,gender);								//매개변수가 Member mem으로 되어있기 때문에 new Member(?)
		...
		while(true) {
			...
			switch(choice) {
			case 1:
				Member m = lc.myInfo();									//this.lc.myInfo();는 안되는가?
