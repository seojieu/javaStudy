...
public class A_for {
	 ...
	 *  				(반복문 안에서 사용 될 변수를 선언및 초기화 하는 작업)
	 *  
	...
	/*	
		...
		*/
		...
		// i = 10 < 10 -> system.out.println("안녕하세요");
		// i = 10 < 10 -> 탈출

		//1 ~ 5 까지 순차적을 출력하세요 (1 2 3 4 5)
...
//			}
			...
			*/
			 ...
			 * 
			 * Math.random() 호출시 -> 0.0 ~ 0.99999999999사이의 랜덤값을 반환
			 * 										0 <= ~ < 1.0
