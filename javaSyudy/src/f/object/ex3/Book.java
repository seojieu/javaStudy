...
public class Book {
	/*
	 	...
	 	protected :같은 패키지 +다른 패키지일 경우 상속관계에서만 접근가능
	 	 dafault : 같은패키지일때만 접근 가능
	 	 private : 오직 해단 클래스에서만 접근 가능
	 */
	//필드
	String title; // 제목
	String genre; // 장르
	...
	//생성자
	//객체를 생성할 때 데이터를 초기화해주는 작업이 필요하다
...
//
	//생성자
	/*
	 	클래스의 이름과 동인한 메소드로 반환형이 없다
	 	필드 데이터의 초기화를 위한 특수목적의 메소드이다.
	 	메개변수가 하나도 없는 생성자를 우리는 기본생성자라고 합니다.
